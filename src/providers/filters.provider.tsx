...
import { createContext, Dispatch, PropsWithChildren, ReactElement, useContext, useReducer } from "react";
...
export default function FiltersProvider({ children, defaultFilters }: props): ReactElement {
