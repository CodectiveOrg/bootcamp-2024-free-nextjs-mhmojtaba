                ...
                <div className={styles.activity_card}>
                  <div className={styles.activity_info}>
                    <svg
                      ...
                      className="plasmic-default__svg plasmic_all__5spGo PlasmicProfileActivity_svg__idGbo__DBfxi lucide lucide-messages-square"
                      viewBox="0 0 24 24"
                      height="1em"
                      role="img"
                    >
                      <path d="M14 9a2 2 0 01-2 2H6l-4 4V4c0-1.1.9-2 2-2h8a2 2 0 012 2v5zm4 0h2a2 2 0 012 2v11l-4-4h-6a2 2 0 01-2-2v-1"></path>
                    </svg>
                ...
                <div className={styles.activity_card}>
                  <div className={styles.activity_info}>
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="plasmic-default__svg plasmic_all__5spGo PlasmicProfileActivity_svg___6IqcG__eoTaK lucide lucide-award"
                      viewBox="0 0 24 24"
                      height="1em"
                      role="img"
                    >
                  ...
                  <div className={styles.onlineBook}>
                    <div className={styles.onlineBookTitle}>
                      <svg
                        ...
                        viewBox="0 0 16 16"
                        height="1em"
                        className="plasmic-default__svg plasmic_all__x8JdJ PlasmicServices_svg__p66RR__KcNoi PlasmicServices_svgtype_onlineVisit__p66RR7QAlK__3Ms1c"
                        role="img"
                      >
                  ...
                  <div className={styles.onlineBook_detail}>
                    <div className={styles.onlineBook_detail_wrapper}>
                      <div className={styles.onlineBook_detail_content}>
                        ...
                        <div className={styles.onlineBook_description}>
                          اولین نوبت آزاد:{" "}
                          {selectedDoctor.firstAvailableAppointment}
                        </div>
                      </div>
                      <button className={styles.onlineBook_btn}>
                        درخواست نوبت آنلاین
                      </button>
                    </div>
                  </div>
                  <div></div>
