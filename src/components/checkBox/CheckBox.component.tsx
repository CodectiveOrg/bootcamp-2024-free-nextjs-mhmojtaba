...
function CheckBoxComponent({ label, value }: CheckBoxProps) {
    ...
    return (
        <div className={styles.container}>
            <label htmlFor={value} className={styles.mainLabel}>{label}</label>
            <div className={styles["checkbox-wrapper"]}>
                <input className={`${styles["tgl"]} ${styles["tgl-flat"]}`} id={value} value={value} type="checkbox" onChange={(e) => onCheckHandler(e)} />
